...
public class ServletPayment extends HttpServlet {
	...
	//TODO
	//remove hashmap ws bank is ready and replace with dynamic call for 1 exchange rate in dopost
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("exchangeRate", this.currencyRates.get(currency));
		...
		switch(action){ 
            ...
            case "payment": 
        		...
        		*/
        		...
        		/* 
        		 * Call bank ws here
        		 * send exchange rate, currency, price in euro, payment info
        		 * get is payment valid  
        		 */
        		
            	request.setAttribute("paiementSuccess", true);
